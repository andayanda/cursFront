  ...
  <div>
    <v-navigation-drawer v-model="drawer" absolute temporary app width="150" height="340">
      <v-list class="pt-4">
        <v-list-tile active-class="green--text" to="/">
         ...
         <v-list-tile active-class="green--text" to="/carmen">
          <v-list-tile-content>
            <v-list-tile-title>Carmen</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
    ...
    <v-toolbar flat dense color="transparent" scroll-off-screen>
      ...
      <v-toolbar-items class="hidden-sm-and-down">
        ...
        <v-btn flat to="/carmen" active-class="green--text headline">Carmen</v-btn>
